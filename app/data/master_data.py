...
MASTER_ITEM_LIST = [
    ...
    {
        "id": "RC03",
        "name": "Single Private Room Ward Accommodation",
        "category": "Room Charges",
    },
    {
        "id": "RC04",
        "name": "Deluxe Room Suite Accommodation Charges",
        "category": "Room Charges",
    },
    {"id": "RC05", "name": "Suite Accommodation Charges", "category": "Room Charges"},
    {
        "id": "RC06",
        "name": "Intensive Care Unit (ICU) Charges per day",
        "category": "Room Charges",
    },
    {
        "id": "RC07",
        "name": "Intensive Coronary Care Unit (ICCU) Charges per day",
        "category": "Room Charges",
    },
    {
        "id": "RC08",
        "name": "Neonatal Intensive Care Unit (NICU) Charges per day",
        "category": "Room Charges",
    },
    {
        "id": "RC09",
        "name": "Pediatric Intensive Care Unit (PICU) Charges per day",
        "category": "Room Charges",
    },
    {"id": "RC10", "name": "Isolation Ward Charges", "category": "Room Charges"},
    {
        "id": "RC11",
        "name": "Labor Delivery Recovery (LDR) Room Charges",
        "category": "Room Charges",
    },
    # =================================================================================
    ...
    {
        "id": "PF01",
        "name": "Initial Doctor Consultation Fee",
        "category": "Professional Fees",
    },
    {
        "id": "PF02",
        "name": "Follow-up Doctor Consultation Fee",
        "category": "Professional Fees",
    },
    {
        "id": "PF03",
        "name": "Emergency Consultation Fee",
        "category": "Professional Fees",
    },
    {
        "id": "PF04",
    ...
    {
        "id": "PF07",
        "name": "Anesthetist Anesthesia Anestesia Fee",
        "category": "Professional Fees",
    },
    {
        "id": "PF08",
        "name": "Nursing Care Charges per day",
        "category": "Professional Fees",
    },
    {
        "id": "PF09",
        "name": "Physiotherapy Session Fee",
        "category": "Professional Fees",
    },
    {
        "id": "PF10",
        "name": "Dietician Consultation Fee",
        "category": "Professional Fees",
    },
    # =================================================================================
    ...
    {
        "id": "PROC01",
        "name": "Minor Operation Theatre Charges",
        "category": "Procedure Charges",
    },
    {
        "id": "PROC03",
        "name": "Wound Dressing and Suture Charges",
        "category": "Procedure Charges",
    },
    {
        "id": "PROC04",
        "name": "Blood Transfusion Charges",
        "category": "Procedure Charges",
    },
    {
        "id": "PROC05",
        "name": "Chemotherapy Administration Charges",
        "category": "Procedure Charges",
    },
    {
        "id": "PROC06",
        "name": "Dialysis Session Charges",
        "category": "Procedure Charges",
    },
    ...
    {
        "id": "DIAG06",
        "name": "Blood Sugar Test (Fasting, Post-Prandial)",
        "category": "Diagnostics",
    },
    {
        "id": "DIAG07",
        "name": "Urine Routine & Microscopy Test",
        "category": "Diagnostics",
    },
    {
        "id": "DIAG08",
        "name": "Dengue Serology Test (NS1, IgG, IgM)",
        "category": "Diagnostics",
    },
    ...
    {
        "id": "IMG08",
        "name": "CT Scan of the Chest or Abdomen",
        "category": "Diagnostics",
    },
    {
        "id": "IMG09",
        "name": "MRI Scan of the Brain or Spine",
        "category": "Diagnostics",
    },
    {
        "id": "IMG10",
        "name": "MRI Scan of a Joint (e.g., Knee)",
        "category": "Diagnostics",
    },
    # =================================================================================
    ...
    {
        "id": "PHARM05",
        "name": "Ondansetron Injection (Anti-emetic)",
        "category": "Pharmacy",
    },
    {
        "id": "PHARM06",
        "name": "Pantoprazole Injection (Antacid)",
        "category": "Pharmacy",
    },
    {"id": "PHARM07", "name": "Normal Saline (NS) IV Fluid", "category": "Pharmacy"},
    {
        "id": "PHARM08",
        "name": "Dextrose Normal Saline (DNS) IV Fluid",
        "category": "Pharmacy",
    },
    {
        "id": "PHARM09",
        "name": "Metformin Tablet (Anti-diabetic)",
        "category": "Pharmacy",
    },
    {
        "id": "PHARM10",
        "name": "Amlodipine Tablet (Anti-hypertensive)",
        "category": "Pharmacy",
    },
    # =================================================================================
    ...
    {
        "id": "IMP02",
        "name": "Intraocular Lens (IOL) for Cataract",
        "category": "Implants",
    },
    ...
    {
        "id": "ADM01",
        "name": "Hospital Admission and Registration Charges",
        "category": "Administrative Charges",
    },
    {
        "id": "ADM02",
        "name": "Medical Records or Folder Fee",
        "category": "Administrative Charges",
    },
    {
        "id": "ADM03",
        "name": "Discharge Summary Certificate Fee",
        "category": "Administrative Charges",
    },
    {"id": "OTH01", "name": "Ambulance Service Charges", "category": "Other Charges"},
    {
        "id": "OTH02",
        "name": "Patient Dietary and Food Charges",
    ...
    {
        "id": "NP02",
        "name": "Water Bottle or Feeding Bottle",
        "category": "Non-Payable Item",
    },
    {"id": "NP03", "name": "Brush for Hair or Teeth", "category": "Non-Payable Item"},
    {
        "id": "NP04",
        "name": "Towel, Napkin or Serviette",
        "category": "Non-Payable Item",
    },
    {
        "id": "NP05",
        "name": "Talcum Powder or Dusting Powder",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP12",
        "name": "Cradle or Baby Cot Charges",
        "category": "Non-Payable Item",
    },
    {"id": "NP13", "name": "Comb", "category": "Non-Payable Item"},
    {
        "id": "NP14",
        "name": "Room Fresheners or Deodorizers",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP17",
        "name": "Food and Beverage charges for others",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP20",
        "name": "Laundry or Washing Charges",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP30",
        "name": "Under Pads or Bed Protectors",
        "category": "Non-Payable Item",
    },
    {
        "id": "NP31",
        "name": "Camera Cover for Endoscopy/Laparoscopy",
        "category": "Non-Payable Item",
    },
    {"id": "NP32", "name": "Diapers or Nappies", "category": "Non-Payable Item"},
    {
        "id": "NP33",
        "name": "DVD or CD for storing medical records",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP37",
        "name": "Hansaplast or Adhesive Bandages",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP41",
        "name": "Certificate or Documentation Charges",
        "category": "Non-Payable Item",
    },
    {"id": "NP42", "name": "Courier Charges", "category": "Non-Payable Item"},
    {
        "id": "NP43",
        "name": "Conveyance Charges for staff or visitors",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP46",
        "name": "Discharge Procedure Charges",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP49",
        "name": "File Opening or Registration Charges",
        "category": "Non-Payable Item",
    },
    {
        "id": "NP50",
        "name": "Incidental or Miscellaneous Charges",
        "category": "Non-Payable Item",
    },
    {
        "id": "NP51",
        "name": "Patient Identification Band or Name Tag",
        "category": "Non-Payable Item",
    },
    {"id": "NP52", "name": "Medicine Box or Container", "category": "Non-Payable Item"},
    {
        "id": "NP53",
        "name": "Medico-Legal Case (MLC) Charges",
        "category": "Non-Payable Item",
    },
    {
        "id": "NP54",
        "name": "Third Party Administrator (TPA) Charges",
        "category": "Non-Payable Item",
    },
    {
        "id": "NP55",
        "name": "Walking Aids like crutches or walkers",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP63",
        "name": "Knee Braces or Immobilizer",
        "category": "Non-Payable Item",
    },
    {"id": "NP64", "name": "Shoulder Immobilizer", "category": "Non-Payable Item"},
    {
        "id": "NP65",
        "name": "Ambulance Collar or Equipment",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP68",
        "name": "Scrub Solution or Sterillium",
        "category": "Non-Payable Item",
    },
    ...
    {
        "id": "NP75",
        "name": "Accu-Chek or Glucometer Strips",
        "category": "Non-Payable Item",
    },
]
    ...
    "MVP1": {
        ...
        "sub_limits": {
            ...
            "Room Charges": {
                ...
                "examples": [
                    "Private A/C Room Rent",
                    "General Ward Bed Charges",
                    "Semi-Private Ward Stay",
                    "Room and Board",
                ],
            },
            "ICU Charges": {
            ...
            "Doctor Consultation": {
                ...
                "examples": [
                    "Daily Doctor Visits",
                    "Fee for Consulting Physician",
                    "Dr. Sharma's Visit Fee",
                ],
            },
            "Surgeon Fees": {
                ...
                "examples": [
                    "Lead Surgeon Fee for Appendectomy",
                    "Surgeon's Charges",
            ...
            "Diagnostics": {
                ...
                "examples": [
                    "Diagnostic Tests (CT, Blood)",
                    "Lab Investigations",
                    "Charges for X-Ray and USG",
                ],
            },
            "Ambulance": {
                "type": "fixed",
