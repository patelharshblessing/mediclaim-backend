...
TEST_CASES = [
    # --- Fixed Limit Rules ---
    {
        ...
        "rule": {"type": "fixed", "value": 3000, "description": "Ambulance charges capped at Rs. 3,000."},
        "sum_insured": 100000
    },
    {
    ...
    },
    {
        ...
        "item": AdjudicatedLineItem(description="Ambulance Charges", quantity=1, unit_price=5000, total_amount=5000, status="Disallowed", allowed_amount=0, disallowed_amount=5000),
        "rule": {"type": "fixed", "value": 3000, "description": "Ambulance charges capped at Rs. 3,000."},
        "sum_insured": 100000
    },
    ...
    },
    {
        ...
        "item": AdjudicatedLineItem(description="Room Rent", quantity=1, unit_price=500, total_amount=500, status="Allowed", allowed_amount=500, disallowed_amount=0),
        "rule": {"type": "percentage_of_sum_insured", "value": 1, "description": "Room Rent capped at 1% of Sum Insured."},
        "sum_insured": 100000
    },
    ...
    # --- Edge Cases ---
    {
        ...
        "item": AdjudicatedLineItem(description="Room Rent", quantity=1, unit_price=0, total_amount=0, status="Allowed", allowed_amount=0, disallowed_amount=0),
        "rule": {"type": "fixed", "value": 3000, "description": "Room Rent capped at Rs. 3,000."},
        "sum_insured": 100000
    },
    {
    ...
    # --- Complex Rules ---
    {
        ...
        "item": AdjudicatedLineItem(description="Surgeon Fees", quantity=1, unit_price=50000, total_amount=50000, status="Allowed", allowed_amount=50000, disallowed_amount=0),
        "rule": {"type": "percentage_of_surgery_cost", "value": 25, "description": "Surgeon fees capped at 25% of surgery cost."},
        "sum_insured": 200000
    },
    {
        "name": "Test 9: Complex Rule - Anesthetist Fees",
        "item": AdjudicatedLineItem(description="Anesthetist Fees", quantity=1, unit_price=15000, total_amount=15000, status="Allowed", allowed_amount=15000, disallowed_amount=0),
        "rule": {"type": "percentage_of_surgeon_fee", "value": 30, "description": "Anesthetist fees capped at 30% of surgeon fees."},
        "sum_insured": 200000
    },
