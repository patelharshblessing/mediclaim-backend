...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_performance_logs_log_id"), "performance_logs", ["log_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "total_items_processed", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "rules_applied_count", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "time_irda_filter_sec",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "time_rule_matching_sec",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "time_rule_application_sec",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        ...
        sa.Column(
            "cost_rule_matching_usd",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "cost_rule_application_usd",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "time_sanity_check_sec",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        sa.Column(
            "cost_sanity_check_usd",
            sa.DOUBLE_PRECISION(precision=53),
            autoincrement=False,
            nullable=True,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["claim_id"],
            ["claims.claim_id"],
            name=op.f("adjudication_logs_claim_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("log_id", name=op.f("adjudication_logs_pkey")),
        sa.UniqueConstraint(
            "claim_id",
            name=op.f("adjudication_logs_claim_id_key"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    op.create_index(
        op.f("ix_adjudication_logs_log_id"),
        "adjudication_logs",
        ["log_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["claim_id"],
            ["claims.claim_id"],
            name=op.f("extraction_logs_claim_id_fkey"),
        ),
        sa.PrimaryKeyConstraint("log_id", name=op.f("extraction_logs_pkey")),
        sa.UniqueConstraint(
            "claim_id",
            name=op.f("extraction_logs_claim_id_key"),
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    )
    op.create_index(
        op.f("ix_extraction_logs_log_id"), "extraction_logs", ["log_id"], unique=False
    )
